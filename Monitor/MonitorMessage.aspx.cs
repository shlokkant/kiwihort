...
public partial class Monitor_MonitorMessage : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            SqlDataSource1.SelectCommand = "Select Efrom,Subjects,Content, switchoffset(convert(datetimeoffset, Sentdate), '+13:00')  from tbl_messages where eTo= '" + Session["email"].ToString() + "' ORDER BY Sentdate DESC";
        }
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            SqlDataSource2.SelectCommand = "Select Eto,Subjects,Content,switchoffset(convert(datetimeoffset, Sentdate), '+13:00') from tbl_messages where efrom= '" + Session["email"].ToString() + "' ORDER BY Sentdate DESC";
        }
        catch (Exception err1)
        {
            Session["error"] = err1.ToString();
